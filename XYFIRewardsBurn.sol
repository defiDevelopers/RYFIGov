...
contract YearnRewards {
  ...
  IERC20 constant public XYFI = IERC20(0x0bc529c00C6401aEF6D220BE8C6Ea1667F6Ad93e);
  ...
  function claimable(address _claimer) public view returns (uint) {
      uint _amount = XYFI.balanceOf(_claimer);
      uint _adai = adai.balanceOf(address(this));
      uint _totalSupply = XYFI.totalSupply();
      uint _balance = XYFI.balanceOf(address(this));
  ...
  function claim(uint _amount) public {
      ...
      XYFI.safeTransferFrom(msg.sender, address(this), _amount);
